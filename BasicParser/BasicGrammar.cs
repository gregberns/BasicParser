...
namespace BasicParser
{
    ...
    public class GWBasicGrammar : Grammar
    {
        ...
        public GWBasicGrammar() : base(false)  // BASIC is not case sensitive...
        {
            ...
            //LINE.Rule = NewLine | NewLine + LINE_CONTENT_OPT + COMMENT_OPT + NewLine | SyntaxError + NewLine;
            ...
            STATEMENT_LIST.Rule = MakePlusRule(STATEMENT_LIST, new_line, STATEMENT);
            //COMMENT_OPT.Rule = short_comment | comment | Empty;

            // A statement can be one of a number of types
            STATEMENT.Rule = IF_STMT | number;
            //ASSIGN_STMT | PRINT_STMT | INPUT_STMT | OPEN_STMT | CLOSE_STMT
            ...
            THEN_CLAUSE.Rule = "then" + STATEMENT_LIST + END_STMT; //STATEMENT_LIST;
            ...
            //VARIABLE_OR_FUNCTION_EXPR.Rule = variable | FUN_CALL | RETURN_STMT;
